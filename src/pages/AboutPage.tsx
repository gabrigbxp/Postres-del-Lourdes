        ...
        <Grid container spacing={6} sx={{ alignItems: "center" }}>
          ...
          <Grid size={{ xs: 12, md: 6 }}>
            ...
            <Typography variant="body1" color="text.secondary" sx={{ mb: 2.5, lineHeight: 1.8 }}>
              Todo empezó en la cocina de casa, con un delantal puesto y mucho entusiasmo. Lourdes
              descubrió su pasión por la repostería mientras preparaba el primer cumpleaños de su
              hijo, y desde entonces nunca paró.
            </Typography>
            <Typography variant="body1" color="text.secondary" sx={{ mb: 2.5, lineHeight: 1.8 }}>
              Años de formación, práctica y perfeccionamiento la llevaron a desarrollar un estilo
              propio: la precisión y técnica de la repostería profesional, con el sabor y el amor
              que solo se logra cuando algo está hecho en casa.
            </Typography>
            <Typography variant="body1" color="text.secondary" sx={{ lineHeight: 1.8 }}>
              Hoy Postres del Lourdes es mucho más que un emprendimiento: es un proyecto de vida
              que crece pedido a pedido, celebración a celebración, poniendo lo mejor en cada
              creación.
            </Typography>
          </Grid>
