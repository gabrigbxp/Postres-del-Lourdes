...
export const GalleryPage = () => {
  ...
  const handlePrev = () =>
    setLightboxPhoto(filtered[(lightboxIdx - 1 + filtered.length) % filtered.length] ?? null);
  const handleNext = () =>
    setLightboxPhoto(filtered[(lightboxIdx + 1) % filtered.length] ?? null);
      ...
      >
        <Container maxWidth="md">
          ...
          <Typography variant="body1" color="text.secondary" sx={{ maxWidth: 500, mx: "auto" }}>
            Cada foto es el resultado de horas de trabajo y mucho amor. Explorá nuestra colección
            y encontrá inspiración para tu próxima celebración.
          </Typography>
        </Container>
      </Box>
