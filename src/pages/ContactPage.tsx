      ...
      >
        <Container maxWidth="md">
          ...
          <Typography variant="body1" color="text.secondary" sx={{ maxWidth: 520, mx: 'auto' }}>
            Estamos para ayudarte. Elegí el canal que más te guste y escribinos. Respondemos todos los días.
          </Typography>
        </Container>
      </Box>
      ...
      <Container maxWidth="md" sx={{ py: 7 }}>
        ...
        <Box
          sx={{
            ...
            borderRadius: 3,
            bgcolor:
              theme.palette.mode === 'light' ? `${theme.palette.primary.light}22` : theme.palette.background.paper,
        ...
        >
          ...
          <Typography variant="body2" color="text.secondary" sx={{ maxWidth: 480, mx: 'auto' }}>
            Para pedidos especiales, contanos el tipo de evento, la cantidad de personas, la fecha y cualquier detalle
            importante. Así podemos darte un presupuesto personalizado lo más rápido posible.
          </Typography>
        </Box>
      </Container>
    </Box>
